...
public class CharaChanger : MonoBehaviour {
	...
	void Update () {
        ...
        if ((Input.GetKey(KeyCode.Space) || isTBdown2) && TranceTime > 20 && AxMan.activeInHierarchy == true)
        {
            JudgementTiMe = 0;
            TranceTime = 0;
        ...
        else if((Input.GetKey(KeyCode.Space) || isTBdown2) && TranceTime < 20)
        {
            this.isTBdown2 = false;
        }
    ...
    //変身ボタンを押した時の処理
    public void GetMyTranceButtonDown2()
    {     
            this.isTBdown2 = true;
